...
public class MainActivity extends AppCompatActivity {
    ...
    final static String CLIENT_ID = "c66601a8-8d35-44ff-9ab3-179e7d13030f";
    final static String SCOPES [] = {"https://graph.microsoft.com/User.Read"};  //여기 링크로 들가니까 머 뜸
    final static String MSGRAPH_URL = "https://graph.microsoft.com/v1.0/me";  //얘도
   ...
   */
        ...
        try {
            ...
            if (users != null && users.size() == 1) {   //로그인 정보 있을 떄 여기로 들어감
          /* We have 1 user */
                Log.i("kimhe", "kimjy");
                sampleApp.acquireTokenSilentAsync(SCOPES, users.get(0), getAuthSilentCallback());
            } else {                                    //로그인 정보가 하나도 없을 때
          /* We have no user */

          /* Let's do an interactive request */
                Log.i("hanjiyeon", "hanjiyeon");
...
//
     ...
     */
    private void onCallGraphClicked() {         //로그인 버튼 눌렀을 때 실행
        Log.i("concallgraphclicked", "check");
    ...
    private void updateGraphUI(JSONObject graphResponse) {          //로그인 성공 후 object를 text에 써줌
